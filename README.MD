...
<img src="doc/images/computerscare-1.4-all-modules.png" width="900" alt="Computerscare Modules for VCV Rack" />

## Development

Static analysis commands are available through `scripts/dev.sh`:

```bash
scripts/dev.sh cppcheck-vcv-library
scripts/dev.sh clang-tidy-vcv-library
scripts/dev.sh static
```

Use `RACK_DIR=/path/to/Rack-SDK` when the Rack SDK is not in the default local path.
...
- [Blunch](./doc/blunch.md): Text-based polyphonic trigger sequencer
...
- [VolyPector](./doc/volypector.md): 16 editable polyphonic CV bands
...
- [Moly Patrix](./doc/moly-patrix.md): Polyphonic matrix mixer
- [Goly Penerator](./doc/goly-penerator.md): Generate constant polyphonic CV via various algorithms
- [Sloly Pit](./doc/sloly-pit.md): Split and route a polyphonic input to 16 outputs
- [Mely Porge](./doc/mely-porge.md): Polyphonic merge / insert / vca utility
...
- [Portaloof](./doc/portaloof.md): Real-time screen feedback and glitch effect module. Captures the VCV Rack window each frame and applies a recursive chain of geometric, mirror, and color transforms
