...
- [I Love Cookies](./doc/i-love-cookies.mb): Signal/CV sequencer, programmed by text input
- [Oh Peas! Quad Quantenuverter](./doc/oh-peas): Polyphonic 4-Channel attenuverter, offsetter, quantizer
...
- [Toly Pools](./doc/poly-utilities.md): Polyphonic utilities: rotate, set/get/display polyphonic channel count
...
- [Custom Blank](./doc/custom-blank.mb): Resizable blank module.  Load your own image file (.png, .jpeg, .bmp)
