...
- [Portaloof](./docs/Portaloof.md): Real-time screen feedback and glitch effect module. Captures the VCV Rack window each frame and applies a recursive chain of geometric, mirror, and color transforms
