# 2.3.11
VolyPector:
- 16 polyphonic signals, with a compact UI.  Edit by signal, or by channel.  Triggered randomization/wiggle per channel or signal.
...
- Static analysis checker scripts, and CI integration
